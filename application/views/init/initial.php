...
<head>
  ...
  <title>Contenedores Company</title>
  ...
  <!-- Favicon -->
  <link rel="icon" href="<?=base_url('resources/assets/img/brand/favicon.png')?>" type="image/png">
  <!-- Fonts -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
  <!-- Icons -->
  <link rel="stylesheet" href="<?=base_url('resources/assets/vendor/nucleo/css/nucleo.css')?>" type="text/css">
  <link rel="stylesheet" href="<?=base_url('resources/assets/vendor/%40fortawesome/fontawesome-free/css/all.min.css')?>" type="text/css">
  <!-- Page plugins -->
  <!-- Argon CSS -->
  <link rel="stylesheet" href="<?=base_url('resources/assets/css/argon.mine209.css?v=1.0.0')?>" type="text/css">
